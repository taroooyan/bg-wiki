...
For support: join the [[Safecast Device Discussions and Support group|https://groups.google.com/forum/?hl=en#!forum/safecast-devices]]. Read the [[community-edited Nano wiki pages|https://github.com/Safecast/bGeigieNanoKit/wiki/_pages]] (among the pages this kit assembly manual alias http://nano.safecast.org/). Or for a technical source one might begin at [[README.md|https://github.com/Safecast/bGeigieNanoKit/blob/master/README.md]] within the larger [[Nano github repository|https://github.com/Safecast/bGeigieNanoKit]]. Surf the Safecast website http://blog.safecast.org/ and the links on the home page. Contact info@safecast.org.
